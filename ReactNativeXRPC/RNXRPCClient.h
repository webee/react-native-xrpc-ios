...
- (nonnull RACSignal<RNXRPCReply *> *)subCall:(nonnull NSString *)proc args:(nullable NSArray *)args kwargs:(nullable NSDictionary *)kwargs;

- (nonnull RACSignal<RNXRPCReply *> *)subCall:(nonnull NSString *)proc context:(nullable NSDictionary *)context args:(nullable NSArray *)args kwargs:(nullable NSDictionary *)kwargs;
